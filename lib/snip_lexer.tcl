...
proc snip_lex {} {
    ...
    while {1} {
        ...
        # rule 9: (SELECTED_TEXT|CLIPBOARD|CURRENT_(LINE|WORD|DATE|TIME|MON|MONTH|MON1|MON2|DAYN|DAYNAME|DAY1|DAY2|YEAR2|YEAR)|DIRECTORY|FILEPATH|FILENAME|LINE_INDEX|LINE_NUMBER|CLIPHIST\[[0-9]+\])
        if {$::snip__state_table($snip__current_state) && \
                [regexp -start $::snip__index -indices -line  -- {\A((SELECTED_TEXT|CLIPBOARD|CURRENT_(LINE|WORD|DATE|TIME|MON|MONTH|MON1|MON2|DAYN|DAYNAME|DAY1|DAY2|YEAR2|YEAR)|DIRECTORY|FILEPATH|FILENAME|LINE_INDEX|LINE_NUMBER|CLIPHIST\[[0-9]+\]))} $::snip__buffer snip__match] > 0 && \
                [lindex $snip__match 1] - $::snip__index + 1 > $::snip_leng} {
            set ::snip_text [string range $::snip__buffer $::snip__index [lindex $snip__match 1]]
            set ::snip_leng [string length $::snip_text]
