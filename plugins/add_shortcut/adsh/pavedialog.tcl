...
oo::class create PaveDialog {
  ...
  method Query {icon ttl msg buttons defb args} {
    ...
    #  - color of labels
    set optsLabel [set chmsg [set geometry ""]]
    set optsMisc ""
    set optsTags 0
    ...
    # add the buttons
    my appendButtons $pWindow.pavedlg widlist $buttons h__ L
    ...
    my showModal $pWindow.pavedlg -focus $pWindow.pavedlg.$defb -geometry $geometry {*}$root
