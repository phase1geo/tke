...
namespace eval pref_test {
  ...
  proc on_pref_ui {w} {
    ...
    api::preferences::widget text        $w "Message" "Enter a message here" -height 2
    # api::preferences::widget table       $w "Table" "Nice Table" -height 3 -columns [list 0 "Column A" 0 "Column B"]
