namespace eval syntax {
  ...
  proc run_test1 {} {
    ...
    if {[$txt syntax ranges miscellaneous1] ne [list 2.0 2.8 2.13 2.22]} {
...
<html>
  ...
  ?>
    ...
    if {[$txt syntax ranges miscellaneous1] ne [list 2.0 2.6 3.2 3.20 10.0 10.7]} {
      cleanup "Tag miscompare ([$txt syntax ranges miscellaneous1])"
    }
    if {[$txt syntax ranges comment] ne [list 3.2 3.20 5.4 6.0]} {
      cleanup "Block comment miscompare ([$txt syntax ranges comment])"
    }
